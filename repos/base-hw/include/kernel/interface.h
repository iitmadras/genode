...
namespace Kernel
{
	...
	constexpr Call_arg call_id_switch_nw_sw_arg() 	  { return 15; }
	/*****************************************************************
	...
	*/
	inline void switch_nw_sw(addr_t a1) 
	{
		call(call_id_switch_nw_sw(), a1);
	}
	
	inline void switch_nw_sw_arg(addr_t a1, addr_t a2) 
	{
		call(call_id_switch_nw_sw(), a1, a2);
	}
	/**
