...
INC_DIR += $(REP_DIR)/src/core/include/spec/imx6/trustzone

# add C++ sources
SRC_CC += spec/imx6/trustzone/platform_support.cc
SRC_CC += spec/imx6/trustzone/platform_services.cc
SRC_CC += spec/imx6/trustzone/pic.cc
...
include $(REP_DIR)/lib/mk/cortex_a9/core-tz.inc
