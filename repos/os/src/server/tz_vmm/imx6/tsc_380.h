...
class Tsc_380 : Genode::Mmio
{
	...
	public:
		...
		Tsc_380(Genode::addr_t const base) : Genode::Mmio(base)
		{
			...
			write<Region_low<REGION5_REG_OFF> >(0x30000000);
			write<Region_attr<REGION5_REG_OFF>::Enable>(1);
			write<Region_attr<REGION5_REG_OFF>::Size>(Region_attr<REGION15_REG_OFF>::Size::SZ_512M);
			write<Region_attr<REGION5_REG_OFF>::Normal_read>(1);
			write<Region_attr<REGION5_REG_OFF>::Normal_write>(1);
			write<Region_attr<REGION5_REG_OFF>::Secure_read>(1);
			write<Region_attr<REGION5_REG_OFF>::Secure_write>(1);
